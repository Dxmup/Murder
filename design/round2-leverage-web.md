...
## The third goal = respond to your pressure
Each character gains a **third goal**: how they answer their pressure — **comply, resist, or exploit it**. Some are inter-group; many are internal moral/strategic choices. (Deliberately expands §8’s “main + 2 sub” to **main + 2 sub + 1 pressure**, because Playtest 02 proved players need a win-condition that isn’t the mystery and isn’t Eleanor’s gate.)
...
## B. The pressure spectrum (one primary pressure per character)

**T = type:** INST (institutional/career) · FIN (financial) · LEG (legal) · SOC (social/reputational) · PER (personal/emotional) · LEV (interpersonal leverage). **Twist? = does it genuinely recontextualize the character** (reserve these).

| # | Character | T | The pressure (source) | Twist? |
|---|---|---|---|---|
| C12 | **Ruiz** | INST | The **Police Commissioner** hints that a clean arrest tonight cements her promotion to Lieutenant — tempting her to bend the rules vs. do the honest work. *(flagship internal dilemma)* | no |
| C10 | Eleanor | INST | The publisher’s “kill it or run it by midnight”; the board watching her masthead. | no |
| C16 | Rick | INST | His editor: redeem the debunked photo tonight or it’s your obit. | no |
| C18 | Farah | INST | An academic rival will steal lead authorship unless she publishes first. | no |
| C13 | Patrice | INST | Donor-exposure risk (Meridian’s checks bear her name); a career-defining side to pick. | no |
| C05 | Grayson | FIN | His short is exposed and the window’s closing; Vivian dangles a buyout to sit on it. | no |
| C11 | Cody | FIN | His channel needs a viral moment tonight or the relevance (and revenue) evaporates. | no |
| C20 | Rafi | FIN | A large unpaid tab he needs settled; the police case threatens his cash side-business. | no |
...
**Only 4 twists** (the Nadia–Arthur–Wren knot + Amara–Vivian). Everyone else has a *stable* pressure that forces a choice. Light one-way vulnerabilities may color a few others (e.g., Wren happens to know Rick’s old “photo” was his own fake; Simone has receipts on a Cody stunt) — flavor, not required arcs.

---

## C. The third (pressure) goal — all 20

| # | Character | Pressure goal |
|---|---|---|
| C01 | Renata | Force recognition before midnight — lean on the paper’s money trail when blood fails. |
| C02 | Dorian | Keep Simone’s public vouching and stay ahead of Rick. |
| C03 | Arthur | Make Nadia answer for Jan 12 — a concession, or expose her. |
| C04 | Nadia | Keep Arthur and Wren in check without either realizing the other could destroy you. |
| C05 | Grayson | Move the story or take Vivian’s buyout — decide before the window shuts. |
| C06 | Vivian | Contain the model-provenance question — buy, threaten, or bury it. |
| C07 | Marisol | Shield your workers from the case — by alliance (Patrice) or leverage, not luck. |
| C08 | Amara | Survive Vivian — publish, or bargain from the one card she can’t answer. |
| C09 | Wren | Get out from under Nadia’s hold — neutralize it or turn it around. |
| C10 | Eleanor | Keep the paper’s entanglement buried while you make the publish call. |
| C11 | Cody | Land the viral moment — without getting exposed as staged. |
| C12 | **Ruiz** | **Decide how far you’ll bend for the Commissioner’s promotion — crack the case clean, or cut a corner.** |
| C13 | Patrice | Pick the winning side and bury the donor tie before it’s sold. |
| C14 | Nikos | Trade your story to whoever protects your cook — not whoever exposes him. |
| C15 | Eddie | Don’t take the fall — flip, align with Rafi, or hold, before Ruiz decides for you. |
| C16 | Rick | Land a scalp and redeem the photo before your own past surfaces. |
| C17 | Simone | Protect the legend — blunt Cody and keep your believers intact. |
| C18 | Farah | Secure the definitive verdict and the lead credit — without getting caught shading. |
| C19 | Manny | Turn the dead-drop into paid leverage before Ruiz compels it for free. |
| C20 | Rafi | Get Eddie to corroborate you — or get ahead of him. |

---

## D. Dynamic messages — escalation first, twist rarely

Most threads **escalate** across the acts (stakes ratchet: hint → pressure → ultimatum) while the character stays who they are. Only the ~4 twist threads truly **detonate**. Messages are **rich and specific** — dated events, named stakes, a voice — replacing thin one-liners.

### Flagship A — an ESCALATING INTERNAL pressure (Ruiz / the Commissioner)
- **Act 1 → Ruiz:** *“The Commissioner asked about you by name at the budget meeting. Close something clean this week and the Lieutenant’s bars are yours. —Deputy Chief’s office”*
- **Act 2 → Ruiz:** *“The board meets Friday. One arrest — doesn’t have to stick forever, just has to hold the headline through the weekend — and you’re Lieutenant Ruiz. You’ve waited eleven years.”*
- **Act 3 → Ruiz:** *“Name a suspect tonight and I sign the promotion Monday. You know how this works. —the Commissioner”* — the player chooses: manufacture a suspect (illegal pressure, fast win) or hold the line (harder, honest). No other player required; the drama is *internal.*
