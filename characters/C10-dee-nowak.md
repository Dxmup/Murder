...
Veridian invited you because the building has become part of the R legend. You came because an audit has flagged a camera interval that was not preserved, and because questions about Vale's route are beginning to circle you and your neighbors.

You need to protect your pension, protect someone who relied on an informal favor, and tell the truth about an access gap. Those aims may not survive together. If the room decides a camera gap equals murder, you are the easiest person to blame.

## Your history

You have worked through owners who deferred repairs, contractors who blamed tenants, and technology upgrades that created cleaner reports without creating a safer building. The service routes are not secret tunnels. They are loading passages, fire doors, basement corridors, and practical shortcuts used by people whose work happens outside office hours.
...
You distrust neat stories. Buildings generate gaps because equipment fails, people improvise, and records were designed for insurance rather than truth. The service exit use may matter. It may also be an ordinary movement made sinister by Vale's absence.

You currently think humans used R-associated infrastructure, probably more than one. That does not establish that R was human or plural. Automation can reserve doors and alter warnings; a human can schedule automation; a remote operator can intervene. You will not let technical language convert uncertainty into intent.
...
You disabled, failed to preserve, or allowed the loss of a camera record for a reason unrelated to R. The exact reason protected a tenant and an informal use of the building. You did not erase proof of Vale's murder. You also cannot prove that nothing important occurred during the gap.
...
City Hall can protect your pension or bury you beneath procedure. Celeste will offer help in exchange for a useful coalition. Ask whether that protection includes the tenant and the building, not merely you.

### Manny Diallo, if present

Manny used routes you controlled and knows timing you do not. Off-book work may carry consequences greater than this party understands. Seek facts without demanding self-exposure.
...
Messages may distinguish the camera gap from an automated intervention. Preserve that distinction even when frightened players want a murder story. You control your objects and disclosures. Nobody has police power, and nobody may compel you to surrender a record.

Let relationships influence you. You may risk your pension for a neighbor, or decide that silence now endangers everyone. Just do not claim to identify a person you never saw.

## At the end

Vote for the reconstruction you believe, using instinct and trust as well as records. Separately choose whether Dee reveals the unrelated camera secret and clarifies the timeline, or preserves it and remains a plausible accomplice. Your choice affects your future; it does not authenticate R or establish Vale's fate.
